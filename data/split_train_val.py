...
if __name__ == "__main__":
    img_train_val_test = Path(r'img_train_val') # WindowsPath of mri scans folder
    mask_train_val_pathes = sorted(Path(r"mask_train_val").glob('*.npy')) # WindowsPath of all masks
