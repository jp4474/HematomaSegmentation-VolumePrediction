...
parser.add_argument("-npz_dir", type=str, default="npz/MedSAM_train/CT_Abd",
                    help="Path to the directory containing preprocessed .npz data, [default: npz/MedSAM_train/CT_Abd]")
parser.add_argument("-npy_dir", type=str, default="npy",
                    help="Path to the directory where the .npy files for training will be saved, [default: ./npy]")
